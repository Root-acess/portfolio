...
const Contact = () => {
  ...
  return (
    <div className="main">
      <div className="up">
        <button className="card1" onClick={() => redirectTo('https://wa.me/8984443551')}>
        ...
        <button className="card2" onClick={() => redirectTo('https://www.linkedin.com/in/hiralal-singh-51251a235')}>
      ...
      <div className="down">
        <button className="card3" onClick={() => redirectTo('https://github.com/root-acess')}>
        ...
        <button className="card4" onClick={() => redirectTo('https://discord.com/invite/YOUR_DISCORD_INVITE')}>
